...
// LED Indicators - Using GPIO 8 and GPIO 9 as power sources for LEDs
#define LED_STATUS     8  // GPIO8 - Status LED (system working)
#define LED_TRANSMIT   9  // GPIO9 - Transmit LED (data transmission)
