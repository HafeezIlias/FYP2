...
import { Settings, Radio, Route, Plane, LogOut } from 'lucide-react';
      ...
      hikers.forEach(hiker => {
        ...
        if (hiker.lat !== 0 && hiker.lon !== 0) {
          hikerHistoryService.addTrackPoint(
            ...
            hiker.lon,
            hiker.lastUpdate,
            hiker.altitude // Pass altitude if available
          );
        }
      });
    }
    ...
    <div className="app">
      ...
      <header className="app-header">
        <div className="app-header__title">
          <img src="/logo192.png" alt="TrailBeacon Logo" style={{ width: '32px', height: '32px' }} />
